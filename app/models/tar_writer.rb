...
# Taken from Gem::Package::TarWriter - the class that ships with
# ruby itself. We hit https://github.com/OSC/phylogatr-web/issues/73
# and so removed the limit of 100 characters.
